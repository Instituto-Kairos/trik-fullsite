...
| Pontifex Maximus | Religioso | Mais alto nível de Sacerdote dentro de Nova Roma, também dando apoio ao Cônsul e sendo responsável por práticas religiosas na cidade;
| Pretor | Cívico-Militar | São eleitos dois a cada dois anos. Havia uma regra que exigia que fosse um rapaz e uma moça, mas ela caiu em 1950, mudando apenas para não poder ser da mesma Philosophia (um testo criado especificamente para isso, será detalhado abaixo);
...
| Primeiro Tenente | Acadêmico | Coordena uma turma na Academia, preparando e formando probatios;
| Centurião | Militar | Líder Mílitar de uma Legião. Em tempos antigos, era Lider de uma Centena de Legionários, mas não é mais utilizado essas divisões;
| Segundo Tenente | Acadêmico | Subcoordena uma turma na Academia, preparando e formando probatios;
| Decurião | Militar | Sub-Líder de uma Legião, responsável por uma divisão da Coorte;
| Signifer | Militar | Porta-Estandarte. É um cargo de honra;
| Vestais  | Religioso | Mantém a chama dos Templos acesas. É um cargo de honra;
| Probatio | Militar | Iniciante no Exército;
...
## Acampamento Júpiter
ㅤㅤㅤ ㅤO exército de Roma fica centralizado em um Acampamento ao Sul da Cidade. Esse acampamento é dividido em cinco coortes. Essas coortes passaram por mudanças em 1945, retirando o sistema que foi considerado de "Castas" e se tornando algo menos elitizado. Apesar das mudanças, algumas velhas impressões se mantiveram e são, até hoje, motivo de pequenas richas e preconceitos entre as coortes. Tais práticas são desencorajadas por responsáveis do setor Militar.

<!-- ANEDOTA -->
[Anedotas da Nova Roma #1: Coortes]
<br><br>
"A primeira coorte é uma coorte de fachada e..."
<br><br>
"Vincent. Eles são uma Coorte de Lembrança, eles lembram e honram os costumes antigos."
<br><br>
"Eles são uns metidos!"
<br><br>
"Vincent Denvir. Eu não irei me repetir. Não perca o meu tempo com suas futilidades. Escreva o que foi solicitado."
<br><br>
"Sim, Pretora. Desculpe, Pretora."
<br><br><br><br>
<!-- /ANEDOTA -->
